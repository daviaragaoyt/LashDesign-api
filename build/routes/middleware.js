...
//  */
// export const autenticar: RequestHandler = (req: any, res: any, next: NextFunction): void => {
...
//     // Extensão da propriedade 'pessoa' no Request (lembre-se de estender a interface Express.Request)
//     req.Pessoa = decoded;
//     next();
//   } catch (err) {
//     res.status(401).json({
